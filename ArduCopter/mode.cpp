...
Mode *Copter::mode_from_mode_num(const Mode::Number mode)//根据传入的数据(mode)，返回对应的模式
{
    Mode *ret = nullptr;
...
bool Copter::set_mode(Mode::Number mode, ModeReason reason)//设置模式:地面站设置模式、遥控器三段开关设置模式
{
